...
class FreeBoardServiceImplTest {
    ...
    @Test
    void selectAllFBoNoDesc() throws Exception {
        FreeBoardListPageMakerDto freeBoardListPageMakerDto = freeBoardService.selectAllFBoNoDesc(1);
        System.out.println("freeBoardListPageMakerDto = " + freeBoardListPageMakerDto);
    }

    @Test
    void selectAllReadCountDesc() throws Exception {
        FreeBoardListPageMakerDto freeBoardListPageMakerDto = freeBoardService.selectAllReadCountDesc(1);
        System.out.println("freeBoardListPageMakerDto = " + freeBoardListPageMakerDto);
    }
