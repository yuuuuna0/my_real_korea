...
CREATE TABLE tour_type(
		to_type_no                    		NUMBER(10)		 NULL ,
		to_type_name                  		VARCHAR2(10)		 NULL 
);

DROP SEQUENCE tour_type_to_type_no_SEQ;

CREATE SEQUENCE tour_type_to_type_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
CREATE TABLE pay_method(
		p_method_no                   		NUMBER(10)		 NULL ,
		p_method_name                 		VARCHAR2(10)		 NOT NULL
);

DROP SEQUENCE pay_method_p_method_no_SEQ;

CREATE SEQUENCE pay_method_p_method_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
ALTER TABLE tour_type ADD CONSTRAINT IDX_tour_type_PK PRIMARY KEY (to_type_no);
...
ALTER TABLE tour ADD CONSTRAINT IDX_tour_FK1 FOREIGN KEY (to_type_no) REFERENCES tour_type (to_type_no) on delete cascade;
...
ALTER TABLE pay_method ADD CONSTRAINT IDX_pay_method_PK PRIMARY KEY (p_method_no);
...
ALTER TABLE payment ADD CONSTRAINT IDX_payment_FK3 FOREIGN KEY (p_method_no) REFERENCES pay_method (p_method_no)  on delete cascade;

ALTER TABLE reserve_person_info ADD CONSTRAINT IDX_reserve_person_info_PK PRIMARY KEY (rs_p_no)  on delete cascade;
ALTER TABLE reserve_person_info ADD CONSTRAINT IDX_reserve_person_info_FK0 FOREIGN KEY (p_no) REFERENCES payment (p_no)  on delete cascade;
...
ALTER TABLE user_img ADD CONSTRAINT IDX_user_img_PK PRIMARY KEY (user_img_no)  on delete cascade;
