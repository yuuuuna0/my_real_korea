...
-- 공지사항 notice insert
insert into notice(n_no,n_title,n_content,n_date,n_readcount,n_img,user_id) values (notice_n_no_seq.nextval,'공지사항1','공지사항내용1',sysdate,0,'img.png','kms1'); 
insert into notice(n_no,n_title,n_content,n_date,n_readcount,n_img,user_id) values (notice_n_no_seq.nextval,'공지사항2','공지사항내용2',sysdate,0,'img.png','kms2'); 
insert into notice(n_no,n_title,n_content,n_date,n_readcount,n_img,user_id) values (notice_n_no_seq.nextval,'공지사항3','공지사항내용3',sysdate,0,'img.png','kms3'); 
